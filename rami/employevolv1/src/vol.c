...
store=gtk_list_store_new (COLUMNS, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING, G_TYPE_STRING);
  ...
  gtk_list_store_set (store, &iter, ID_VOL, id_vol, DEPART, depart, DESTINATION, destination, JOURDepart, jourDepart, MOISDepart, moisDepart, ANNEEDepart, anneeDepart, JOURArriver, jourArriver, MOISArriver, moisArriver, ANNEEArriver, anneeArriver, COMPAGNIE, companie, PRIX, prix, -1);
    }
    fclose(f);
